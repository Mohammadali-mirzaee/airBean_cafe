        ...
        <div className="sideNav">
          ...
          <div className="links">
            <ul>
              ...
              <li>
                <Link onClick={changlik} className="a" to="/about">
                  Vårt Kaffe
                </Link>
              </li>
              <li>
                ...
                <Link onClick={changlik} className="a" to="/status">
                  Order Status
                </Link>
              </li>
            </ul>
